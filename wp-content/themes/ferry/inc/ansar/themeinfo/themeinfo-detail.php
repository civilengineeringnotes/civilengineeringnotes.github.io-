			...
			<div class="changelog point-releases">
				<div class="under-the-hood two-col">
					...
					<div class="col">
						...
						<p><a href="<?php echo esc_url( 'https://themeansar.com/docs/wp/ferry/' ); ?>" target="_blank" class="button button-secondary"><?php esc_html_e( 'Documentation', 'ferry' ); ?></a></p>
					</div>
					...
					<div class="col">
						...
						<p><a href="<?php echo esc_url( 'https://wordpress.org/support/theme/ferry' ); ?>" target="_blank" class="button button-secondary"><?php esc_html_e( 'Support Forum', 'ferry' ); ?></a></p>
					</div>
					...
					<div class="col">
						...
						<p><a href="<?php echo esc_url( 'https://themeansar.com/demo/wp/ferry/default/' ); ?>" target="_blank" class="button button-secondary"><?php esc_html_e( 'View Pro', 'ferry' ); ?></a></p>
					</div>

					<div class="col">
						<h3><?php esc_html_e( 'Got sales related question?', 'ferry' ); ?></h3>
						<p><?php esc_html_e( 'Please send it via our sales contact page.', 'ferry' ) ?></p>
						<p><a href="<?php echo esc_url( 'https://themeansar.com/contact/' ); ?>" target="_blank" class="button button-secondary"><?php esc_html_e( 'Contact Page', 'ferry' ); ?></a></p>
					</div>
					...
					<div class="col">
						...
						<p>
							<a href="<?php echo esc_url( 'http://translate.wordpress.org/projects/wp-themes/ferry' ); ?>" target="_blank" class="button button-secondary">
								<?php
								esc_html_e( 'Translate', 'ferry' );
								echo ' ' . $theme->display( 'Name' );
								?>
