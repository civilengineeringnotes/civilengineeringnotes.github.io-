  ...
  <div class="ferry-footer-copyright">
    <div class="container">
      <div class="row">
			...
			<?php echo get_theme_mod('ferry_footer_copyright_setting',__('<p>&copy; Copyright 2019 by <a href="#">Ferry</a>. All Rights Reserved. Powered by <a href=" https://wordpress.org/">WordPress</a></p>','ferry')); ?>
			</div>
			<?php } ?>
